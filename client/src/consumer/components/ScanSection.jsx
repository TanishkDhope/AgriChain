  ...
  return (
    <>
      ...
      <div className="bg-white rounded-2xl shadow-lg border-2 border-green-200 p-8 text-center mb-8 hover:shadow-xl transition-shadow">
        ...
        <h3 className="text-3xl font-bold text-gray-900 mb-4">Scan Product QR Code</h3>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6">
        ...
        {scanHistory.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">No scans yet. Start by scanning your first product!</p>
          </div>
        ) : (
            ...
            {scanHistory.slice(0, 5).map((scan) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <CheckCircle 
                    className={`h-5 w-5 ${
                      scan.status === 'Verified' ? 'text-green-500' : 'text-yellow-500'
                    }`} 
                  />
                  <span 
