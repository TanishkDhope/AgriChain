...
import { QrCode, History, Flag, Globe, Leaf, Star, Shield, Truck, Camera, Upload, X } from 'lucide-react';
...
export default function ConsumerHomePage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #f0fdf4, #ecfdf5, #f7fee7)' }}>
      {/* Header */}
      <header 
        className="text-white shadow-2xl sticky top-0 z-50"
        style={{ background: 'linear-gradient(to right, #16a34a, #059669, #16a34a)' }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold tracking-tight">AgriChain</h1>
                <p className="text-xs sm:text-sm hidden sm:block" style={{ color: '#bbf7d0' }}>
                  Supply Chain Transparency
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <Button variant="ghost" size="icon" className="text-white rounded-xl hover:bg-white/20">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-4xl font-bold mb-4">Track Your Food's Journey</h2>
            <p className="text-xl max-w-2xl mx-auto" style={{ color: '#bbf7d0' }}>
              From farm to table, ensure authenticity and quality with blockchain-powered traceability
            </p>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6 sm:space-y-8">
            ...
            <Card className="card-hover border-2" style={{ 
              borderColor: 'rgba(163, 230, 53, 0.6)',
              background: 'linear-gradient(135deg, #ffffff, rgba(240, 253, 244, 0.3))'
            }}>
              <CardHeader className="text-center pb-4 sm:pb-6">
                ...
                <CardTitle className="gradient-text text-2xl sm:text-3xl">Scan Product QR Code</CardTitle>
                <CardDescription className="text-base sm:text-lg">
                  Verify authenticity and trace your product's journey from farm to table
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button
            ...
            <Card className="card-hover">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-xl sm:text-2xl">Recent Scans</CardTitle>
                    <CardDescription>Your previously scanned products and their status</CardDescription>
                  </div>
                </div>
              </CardHeader>
                ...
                {mockTransactions.map((transaction) => (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-slate-600 mt-1">{transaction.origin}</p>
                      <p className="text-xs text-slate-500 mt-1">{transaction.date}</p>
                    </div>
                    <div className="ml-4">
                      <Badge
                        variant={transaction.warranty === "Active" ? "default" : "secondary"}
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            {/* Report Issues */}
            <Card className="card-hover border-red-200" style={{
              background: 'linear-gradient(135deg, #ffffff, rgba(254, 242, 242, 0.3))'
            }}>
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-lg sm:text-xl">Report an Issue</CardTitle>
                    <CardDescription>Help us maintain supply chain integrity</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center">
            ...
            <p className="text-sm sm:text-base mb-6">
              Powered by blockchain technology for transparent supply chains
            </p>
            <div className="flex flex-wrap justify-center gap-4 sm:gap-8">
              <button className="hover:text-green-400 transition-colors text-sm sm:text-base">Privacy Policy</button>
              <button className="hover:text-green-400 transition-colors text-sm sm:text-base">Terms of Service</button>
              <button className="hover:text-green-400 transition-colors text-sm sm:text-base">Contact Support</button>
              <button className="hover:text-green-400 transition-colors text-sm sm:text-base">About Us</button>
            </div>
            <div className="mt-6 pt-6 border-t border-slate-800">
              <p className="text-xs sm:text-sm text-slate-400">
                © 2025 AgriChain. All rights reserved. Building trust through transparency.
              </p>
            </div>
          </div>
        </div>
