  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative aspect-square rounded-3xl overflow-hidden shadow-2xl transition-all duration-300 group backdrop-blur-lg bg-white/80 border border-white/50">
        ...
        {/* Image Counter */}
        <div className="absolute bottom-4 right-4 px-4 py-2 rounded-xl text-sm font-semibold backdrop-blur-md shadow-lg bg-white/90 text-slate-700 border border-white/50">
